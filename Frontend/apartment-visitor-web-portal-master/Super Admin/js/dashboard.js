...
//     // Step 1: Log the stored user data string
//     alert("adgfwe")
...
$(document).ready(function () {
    // Check session storage for user credentials
    ...
    $.ajax({
        ...
        success: function (userData) {
            ...
            // Assuming userData has properties like username, userType, etc.
            $('#user-info').text('Welcome, ' + userData.Username);
        },
    ...
    // Rest of your existing code for displaying visitor data
    // ...
});
